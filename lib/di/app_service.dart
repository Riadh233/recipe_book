...
Future<void> initializeDependencies() async {
  ...
  getIt.registerSingleton<UnbookmarkRecipeUseCase>(UnbookmarkRecipeUseCase(repository: getIt()));
  getIt.registerSingleton<DeleteAllBookmarksUseCase>(DeleteAllBookmarksUseCase(repository: getIt()));
  getIt.registerSingleton<IsRecipeBookmarkedUseCase>(IsRecipeBookmarkedUseCase(repository: getIt()));
  ...
  getIt.registerFactory<BookmarkCubit>(() => BookmarkCubit(getIt()));
  getIt.registerFactory<AppThemeBloc>(() =>AppThemeBloc(saveTheme: getIt(), getTheme: getIt()));
  getIt.registerFactory<FirestoreBloc>(() =>FirestoreBloc(getIt(),getIt(),getIt(),getIt()));
}
